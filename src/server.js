...
良い回答:
はい、労働安全衛生法第59条により、労働者を雇い入れた時には必ず安全衛生教育を実施する義務があります。教育内容は、機械等の危険性・有害性、安全装置や保護具の使用方法、作業手順、事故時の措置などです。また、作業内容を変更した場合も同様に教育が必要です。さらに、危険・有害な業務に就かせる場合は特別教育が必要になります。適切な教育により、新入社員が安全に作業できる知識を身につけることができます。詳細: https://laws.e-gov.go.jp/law/347AC0000000057
